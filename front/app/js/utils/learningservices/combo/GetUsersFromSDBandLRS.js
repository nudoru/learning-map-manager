let {curry, concat}              = require('ramda'),
    ...
    {getUserCourseStatusByEmail} = require('../shadow/ShadowDB'),
    {
...
const requestUsersFromSDBandLRS = (wsConfig, usersArry, onProgressFn = () => {}) =>
...
const _getUser = curry((wsConfig, email) =>
  chainTasks([getUserCourseStatusByEmail(wsConfig.shadowdb, email),
...
const _arrangeResults = curry((username, results) => ({
  [username]: {
    sdb: results[0], lrs: results[1]
  }
}));

module.exports = {requestUsersFromSDBandLRS};