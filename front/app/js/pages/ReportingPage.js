...
// specify "displayOnlyDirectSubs": true in the setup of the config to show only direct subordinates
    render() {
        let structure     = getCurrentStructure(),
            ...
            allEmployees  = state.hierarchy.allEmployees,
            employees     = state.hierarchy.employees,
            tree          = state.hierarchy.tree,
        ...
        if (firstLevelMgr || displayOnlyDirectSubs) {
                                ...
                                <Card hControls={<FilterForm
                                                  ...
                                                  instructions={structure.instructions}/>
                                    {
                                        treeToRender.map(mgr => {
                                            ...
                                            if (!firstLevelMgr && mgrProfile && !displayOnlyDirectSubs) {
